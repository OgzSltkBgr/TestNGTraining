package tests.practiceLesson.practice09;
...
//        Assert.assertEquals(Driver.getDriver().getCurrentUrl(),productPageUrl);
        ...
        automationExercisePage.searchBox.sendKeys("blue");
...
//        actions.click( searchProductPage.searchButton).click().perform();
        ...
        Assert.assertTrue(automationExercisePage.searchedProductTitle.isDisplayed());
        List<WebElement> ürünlistesi = automationExercisePage.searchedProductList;
...
//        }
        ...
        actions.click(automationExercisePage.viewProduct).perform();
        Assert.assertTrue(automationExercisePage.blueTop.isDisplayed());
